...
import HMasc from "../../../public/Hmasculino.jpg";
    ...
    <CardFlip isFlipped={isFlipped} flipDirection="vertical">
      ...
      >
        <div className="card-content h-80 w-80">
          <Image src={HMasc} alt="Handball Femenino" className="h-full w-full object-cover rounded-xl" />
        </div>
      </animated.div>
      ...
      >
        <div className="card-content h-full w-full">
          <h1 className="text-2xl mb-4 mt-12">Juveniles y Mayores Maculino</h1>
          <h2 className="text-xl mb-4">Lunes, Miércoles y Viernes</h2>
          <h2 className="text-xl mb-4">21hs a 22.30hs</h2>
          <h3 className="text-lg">Profesora</h3>
