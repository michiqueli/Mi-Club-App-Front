...
export default function HFemMay() {
  ...
  return (
    <CardFlip isFlipped={isFlipped} flipDirection="veretical">
      {/* Front of the card */}
      <animated.div
        className="card"
        style={{
      ...
      >
        <div className="card-content h-80 w-80">
          <Image src={HMasc} alt="Handball Masculino" className="h-full w-full object-cover rounded-xl" />
        </div>
      </animated.div>
      ...
      >
        <div className="card-content h-full w-full">
          <h1 className="text-2xl mb-4 mt-12">Menores y Cadetes Masculino</h1>
